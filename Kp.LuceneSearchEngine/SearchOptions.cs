...
namespace Kp.LuceneSearchEngine
{
    ...
    public class SearchOptions
    {
        ...
        /// <param name="isHightLight">取多少条</param>
        public SearchOptions(string keywords, string fields, int maximumNumberOfHits = 1000, Dictionary<string, float> boosts = null, Type type = null, string orderBy = null, int? skip = null, int? take = null, bool? isHightLight = null)
        {
            ...
            IsHightLight = isHightLight ?? false;
        ...
        public SearchOptions(string keywords, int page, int size, string fields) : this(keywords, fields, int.MaxValue, null, null, null, (page - 1) * size, size, null)
        {
            if (page < 1)
            {
                page = 1;
        ...
        public SearchOptions(string keywords, int page, int size, bool isHightLight, Type t) : this(keywords, string.Join(",", t.GetProperties().Where(p => p.GetCustomAttributes<LuceneIndexAttribute>().Any()).Select(p => p.Name)), int.MaxValue, null, null, null, (page - 1) * size, size, isHightLight)
        {
            if (page < 1)
            {
                page = 1;
